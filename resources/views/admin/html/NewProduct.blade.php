...
@csrf
  ...
  <p>値段<input type="number" name="price" value="100" min="10" max="10000" step="10"></p>
  
  

      <p>商品説明
	<input type="text" name="explanation"></p>
  ...
  <p>カテゴリー
	<input type="text" name="category"></p>
      ...
      <p>アレルギー
	<input type="text" name="allergy"></p>

  <p>カロリー<input type="number" name="calorie" value="100" min="1" max="10000" step="1"></p>
